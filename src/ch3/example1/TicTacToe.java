...
public class TicTacToe {
	...
	public boolean isWin(int mark) {
		return ((board[0][0] + board[0][1] + board[0][2] == mark * 3) // row 0
				|| (board[1][0] + board[1][1] + board[1][2] == mark * 3) // row
																			// 1
				|| (board[2][0] + board[2][1] + board[2][2] == mark * 3) // row
																			// 2
				|| (board[0][0] + board[1][0] + board[2][0] == mark * 3) // column
																			// 0
				|| (board[0][1] + board[1][1] + board[2][1] == mark * 3) // column
																			// 1
