...
public class LinkedPositionalList<E> implements PositionalList<E> {
	...
	public static void insertionSort(PositionalList<Integer> list) {
		Position<Integer> marker = list.first(); // last position known to be
													// sorted
		while (marker != list.last()) {
			...
			if (value > marker.getElement()) // pivot is already sorted
				...
				Position<Integer> walk = marker; // find leftmost item greater
													// than value
	...
	public static void main(String[] args) {
		...
		LinkedPositionalList[] x;
		x = new LinkedPositionalList[10];
		// x1[i]=new Pair<String,Integer>(na,new Random().nextInt(100));

		Iterator<Double> iter = d.iterator();
		while (iter.hasNext()) {
			Double variable = iter.next();
			System.out.println(variable);
		}

		LinkedList<Double> d1 = null;

		ListIterator<Double> iter1 = d1.listIterator();
